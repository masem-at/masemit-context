...
| Market-cap weighting | Treasury-weighted OR equal-weighted (see Decision 1) |
...
- **Smaller universe** — we'll start with 15-30 DAOs, not 500
...
### 4.2 Rebalancing Rules

- **Frequency:** Monthly (1st of each month)
- **Review:** DAOs that fall below thresholds get a 1-month grace period before exclusion
- **New Additions:** DAOs that newly meet all criteria are added at next rebalancing
- **Announcement:** Changes published 3 days before effective date (like S&P)
...
Every paid report (€49-149) now includes:
...
| **1.4** Rebalancing Logic | Monthly check: add/remove DAOs based on inclusion criteria, 1-month grace period | Automated check on 1st of month, changes announced 3 days before effective | 3h |
...
| Order | Epic | Reason |
|-------|------|--------|
| 1️⃣ | Epic 1 (Foundation) | No index = nothing to display |
| 2️⃣ | Epic 2 (Matrix Integration) | Immediate value on existing page, lead-gen upgrade |
...
**Total Estimated Effort: ~36h dev across all epics**
...
| **D4** | Category Taxonomy | **Keep current 4 categories** (DeFi, Infrastructure, Public Goods, Social) | Sufficient for 50 DAOs at launch. New categories announced individually when justified — each is a content piece. |
...
| **Rebalancing** | Monthly (1st of month, 3-day advance notice) |
| **Update Cadence** | Daily calculation; chart granularity toggle (daily → weekly → monthly) |
| **First Integration** | Benchmark line on Matrix Details Page charts |
| **Lead-Gen Angle** | Tiered access to benchmark data (anon → free → paid) |
| **Content Angle** | Monthly "State of DAO Governance" narratives |
| **Total Effort** | ~36h dev across 4 epics |
| **Sprint Priority** | Foundation → Matrix Integration → Reports → Public Page |

---

*Und jetzt: ab aufs Rad, Sempre! 🚴‍♂️💨*
